...
create_test_() ->
    ...
    ?_assertEqual(not_allowed, utils:create_parking_lot([0])),
    ?_assertEqual(not_allowed, utils:create_parking_lot([-5])),
    ?_assertEqual(not_allowed, utils:create_parking_lot(["5"]))]}.
